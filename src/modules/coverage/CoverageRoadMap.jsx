...
function buildMapData(rows, average) {
  ...
  rows.forEach((row) => {
    ...
    radii.push(circleFeature(Number(row.longitude), Number(row.latitude), Number(row.coverage_radius_miles), {
